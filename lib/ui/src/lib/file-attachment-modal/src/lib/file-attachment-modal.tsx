...
import { formatFileSize } from '@hotel_manage/utils';
import { config } from '@hotel_manage/config';

import { processFileAttachment } from '@hotel_manage/server-actions';
import { useWebSocketContext } from '@hotel_manage/contexts';
