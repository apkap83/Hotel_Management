...
import { ColorModeContext, tokens } from '@hotel_manage/ui-theme';
import { NovaLogo } from '@hotel_manage/assets';
import { LoggedInIndication } from '@hotel_manage/ui';
import {
  AppPermissionTypes,
  AppRoleTypes,
  FilterTicketsStatus,
} from '@hotel_manage/shared-models';
import { userHasPermission, userHasRole } from '@hotel_manage/utils';
